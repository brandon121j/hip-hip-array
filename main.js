...
const final = grades.reverse();
console.log(br);
console.log(br);
console.log(li);
console.log(`CHALLENGE 2 ${final}`);
console.log(li);
console.log(br);
console.log(br);
...
console.log(li)
console.log(br)
const copied = students.slice(3, 11);

for (const stud of copied) {
  console.log(stud)
}
...
console.log(li)
console.log(br)
const dino = ['Velociraptor', 'T-Rex', 'Stegosaurus', 'Triceratops', 'Dimetrodon', 'Allosaur', 'Spinosaurus', 'Gigantosaur']
console.log(dino);
console.log(br)
console.log(li)
console.log(br)
...
const done = primaries.concat(secondaries);
console.log(br)
console.log(li)
console.log(br)
console.log(done)
